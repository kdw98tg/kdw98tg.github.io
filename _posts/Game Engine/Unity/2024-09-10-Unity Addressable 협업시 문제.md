...
![](/assets/images/posts/Pasted%20image%2020240910095244.png)
...
![](/assets/images/posts/Pasted%20image%2020240910095310.png)

그 다음으로 `Schemas` 폴더로 들어가 Schema 참조도 없애 줍니다. 그 다음 다시 Addressable 에셋을 만들어서 매핑시켜 줍니다.

![](/assets/images/posts/Pasted%20image%2020240910095335.png)
